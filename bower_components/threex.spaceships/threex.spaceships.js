...
THREEx.SpaceShips.loadAsteroidS	= function(onLoad){
	var loader	= new THREE.OBJMTLLoader();
	var baseUrl	= THREEx.SpaceShips.baseUrl
	var objUrl	= baseUrl + 'models/Asteroid/asteroid.obj';
	var mtlUrl	= baseUrl + 'models/Asteroid/asteroid.mtl';
...
THREEx.SpaceShips.loadAsteroidB	= function(onLoad){
	var loader	= new THREE.OBJMTLLoader();
	var baseUrl	= THREEx.SpaceShips.baseUrl
	var objUrl	= baseUrl + 'models/Asteroid/asteroid.obj';
	var mtlUrl	= baseUrl + 'models/Asteroid/asteroid.mtl';
	loader.load(objUrl, mtlUrl, function( object3d ){
		object3d.scale.multiplyScalar(1/4)
		// change emissive color of all object3d material - they are too dark
		object3d.traverse(function(object3d){
			if( object3d.material ){
				object3d.material.emissive.set('white')
...
THREEx.SpaceShips.loadAsteroidBB	= function(onLoad){
	var loader	= new THREE.OBJMTLLoader();
	var baseUrl	= THREEx.SpaceShips.baseUrl
	var objUrl	= baseUrl + 'models/Asteroid/asteroid.obj';
	var mtlUrl	= baseUrl + 'models/Asteroid/asteroid.mtl';
...
THREEx.SpaceShips.loadShuttle01	= function(onLoad){
	...
	loader.load(objUrl, mtlUrl, function( object3d ){
		object3d.scale.multiplyScalar(1/600)
		// change emissive color of all object3d material - they are too dark
		object3d.traverse(function(object3d){
			if( object3d.material ){
				object3d.material.emissive.set('white')
...
THREEx.SpaceShips.loadShuttle01S	= function(onLoad){
	var loader	= new THREE.OBJMTLLoader();
	var baseUrl	= THREEx.SpaceShips.baseUrl
	var objUrl	= baseUrl + 'models/Shuttle01/Shuttle01.obj';
	var mtlUrl	= baseUrl + 'models/Shuttle01/Shuttle01.mtl';
	loader.load(objUrl, mtlUrl, function( object3d ){
		object3d.scale.multiplyScalar(1/1800)
		// change emissive color of all object3d material - they are too dark
		object3d.traverse(function(object3d){
			if( object3d.material ){
				object3d.material.emissive.set('white')
